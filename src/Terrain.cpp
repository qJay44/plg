...
void Terrain::draw(const Camera* camera, const Shader& shader, bool forceNoWireframe) const {
  static constexpr vec3 chunkDebugColors[] = {
    {0.200f, 0.659f, 0.780f},
    {0.322f, 0.890f, 0.882f},
    {0.627f, 0.894f, 0.149f},
    {0.992f, 0.945f, 0.282f},
    {1.000f, 0.671f, 0.000f},
    {0.969f, 0.475f, 0.463f},
    {0.941f, 0.314f, 0.682f},
    {0.847f, 0.514f, 1.000f},
    {0.576f, 0.212f, 0.992f}
  };
